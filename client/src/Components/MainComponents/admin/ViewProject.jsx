        ...
        <div className="w-screen h-screen bg-slate-50 p-4 overflow-x-hidden">
            <div className="w-11/12 m-auto">
                <Card className="w-full h-auto rounded-md p-2 relative">
                    <CardHeader>
                        <CardTitle className="font-semibold text-3xl ">Ems (Element Management System)</CardTitle>
                    </CardHeader>
                    <CardContent className="mt-2">
                        <p className="text-lg text-gray-600">This Project Manages the all Systems of the offices</p>
                ...
                <Card className="w-full h-auto p-2 mt-8">
                    <CardHeader>
                        <div className="flex justify-between">
                            <CardTitle className="font-semibold text-2xl ">Activity Logs</CardTitle>
                            <div className="flex space-x-2">
                                <div className=" relative">
                                    {/* <Label htmlFor="email">Email</Label> */}
                                    <CiSearch className="absolute top-1.5 left-1 cursor-pointer w-5 h-5" />
                                    <Input type="text" placeholder="Search Logs.." className="w-52 pl-7" />
                                </div>
