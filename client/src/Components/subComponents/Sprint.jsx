...
const Sprint = ({
  ...
  const { callApi: StartSprint } = usePutApi(
        ...
        <div>
          <div className="flex justify-between">
            ...
            <Button
              ...
              onClick={() => StartSprint({ isStartSprint: true })}
            >
              Start Sprint
            </Button>
          </div>
            ...
            EditEnable ?
              ...
              : <div className=" w-[800px]   grid grid-cols-3">
                <div className="col-span-1">
                  ...
                  <p className="text-gray-500 text-sm">{Dates?.startDate ? Dates?.startDate : <p>Start Date Has Not Selected</p>}</p>
                </div>
                <div className="col-span-1">
                  <p className="text-base font-semibold text-gray-800">EndDate</p>
                  <p className="text-gray-500 text-sm">{Dates.endDate ? Dates.endDate : <p>End Date Has Not Selected</p>}</p>
                </div>
              </div>
          }
            ...
            EditEnable ?
              <>
                <div className="space-x-4">
                  {/*  save button */}
                  <Button variant="outline" className="w-16 mt-4" onClick={() => {
                  ...
                  {/* cancel button */}
                  <Button variant="outline" className="w-8 mt-4" onClick={() => {
              ...
              <Button variant="outline" className="w-8 mt-4" onClick={() => setEditEnable(!EditEnable)}>
                <PencilIcon />
              </Button>
          }
