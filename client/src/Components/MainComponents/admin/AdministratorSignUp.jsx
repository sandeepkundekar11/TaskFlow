        ...
        <div className="w-1/2 p-6">
          <div className="flex justify-between items-center mb-4">
            <p>
              ...
              <NavLink to="/administrativeLogin" className="text-blue-500">
                Login
              </NavLink>
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mb- 4">
              ...
              />
              <p className="mt-1 text-sm font-semibold text-red-600">
                {SignUpInfoWarning?.emailWarning}
              </p>
            </div>
            <div className="mb-4">
              ...
              />
              <p className="mt-1 text-sm font-semibold text-red-600">
                {SignUpInfoWarning?.companyWarning}
              </p>
            </div>
            <div className="mb-4">
              ...
              <div className="w-full border-b-2 border-gray-300 focus:border-blue-500 flex items-center">
                <input
                  ...
                  className=" w-11/12 h-full bg-transparent outline-none py-2"
                  placeholder="••••••••"
                />
                <button
                  onClick={() => {
              ...
              <p className="text-xs text-gray-500 mt-2">
                {passwordWarning.CharacterLength ? (
                  <div>
                    <span className="text-green-500 text-base pr-2">✔</span>
                    Least 8 characters
                  </div>
                ) : (
                  <div>
                    <span className="text-red-500 font-bold text-base pr-2">
                      X
                    </span>
                    Least 8 characters
                  </div>
                )}
                {passwordWarning.IsNumberAvailable ? (
                  <div>
                    <span className="text-green-500 text-base pr-2">✔</span>
                ...
                {passwordWarning.IsLowerAndUpperCase ? (
                  <div>
                    <span className="text-green-500 text-base pr-2">✔</span>
