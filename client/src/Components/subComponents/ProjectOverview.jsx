...
const ProjectOverView = () => {
    const Projects = [
        ...
        },
        {
            ...
            id: 4,
            name: "Ems Project",
            ActiveUsers: ["sandeep", "amir", "anil", "abhishek", "anurag", "jone doe", "harry"],
            Task: 87,
            status: "pending"
        }
    ...
    return (
        <div className="w-[95%]">
                ...
                <Table>
                    ...
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead></TableHead>
                            <TableHead className="flex justify-center items-center">View Project</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {
                            Projects.map((ele) => {
                                return (
                                    <TableRow key={ele.id} className="hover:bg-slate-200">
                                        ...
                                        <TableCell className="font-medium text-base">{ele?.name}</TableCell>
                                        <TableCell className="font-medium text-base">
                                            <AvatarGroup users={ele?.ActiveUsers} />
                                        </TableCell>
                                        <TableCell className="font-medium text-base">{ele?.Task}</TableCell>
                                        <TableCell>
                                            <Badge variant="outline">{ele?.status}</Badge>
                                        </TableCell>
                                        <TableCell>
                                            <CustomPopupProvider buttonName="Edit" Heading={"Edit Project"} ClickHandle={() => {
                                        ...
                                        <TableCell className="flex justify-center">
                                            <Button variant="link" className=" w-32 text-blue-500">View</Button>
                                        </TableCell>
                                    </TableRow>
                                )
                            })
            ...
            <CustomPopupProvider buttonName="Add Project" Heading={"Add New Project"}>
                <input type="text" className="form-control mb-2 mr-sm-2" placeholder="Jane Doe" />
            </CustomPopupProvider>
